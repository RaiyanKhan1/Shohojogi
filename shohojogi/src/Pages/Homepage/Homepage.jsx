...
function Homepage(){
  ...
  return (
    <div>
        <Navbar />
        <div className="flex-col pt-15 md:pt-10 lg:m-10">
        <HeroVideo />
        ...
        <div className="flex flex-col justify-center items-center gap-5 md:gap-8 lg:gap-10 h-50 md:h-100 w-auto lg:rounded-2xl bg-linear-to-br from-green-950 via-green-800 to-green-700 md:border-2 border-green-500 border-b-3 shadow-[0px_1px_0px_rgba(0,0,0,0.2)]">
          <p className="text-2xl md:text-5xl lg:text-6xl text-white font-quicksand">Want to avail services instantly?</p>
      <NoiseBackground
        ...
        <div className='flex h-100 md:w-95% lg:m-2 items-center justify-center lg:rounded-2xl bg-linear-to-br from-slate-800 via-gray-900 to-gray-950'>
