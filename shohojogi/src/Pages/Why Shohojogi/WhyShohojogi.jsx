...
function Card({heading, text}){
    return(
        <div className="flex flex-col justify-evenly h-full min-w-0 flex-1 bg-white border-3 border-b-4 shadow-2xl border-gray-300 text-center p-6  rounded-2xl bg-linear-to-br from-slate-200 via-gray-100 to-white">
  ...
  return (
    <div className="flex flex-col h-full md:m-15 pt-10">
      ...
      <div className="mt-60 w-full">
        ...
        <div className="flex flex-col md:flex-row justify-center h-100 items-stretch gap-10 p-15 w-auto rounded-2xl bg-linear-to-br from-green-950 via-green-800 to-green-700 border-2 border-green-500 border-b-3 shadow-[0px_1px_0px_rgba(0,0,0,0.2)]">
