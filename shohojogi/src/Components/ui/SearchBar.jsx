...
function SearchBar(){
  return (
    ...
    focus-within:-translate-y-px">
        ...
        <input type="text" placeholder="What do you need help with?" className="rounded-4xl h-full w-3/4 md:w-4/5 p-4 border-none outline-none">
        </input>
        ...
        <img src="src/assets/icons/search.svg" className="h-4 w-4 md:h-5 md:w-5"></img>
          Search
        </button>
