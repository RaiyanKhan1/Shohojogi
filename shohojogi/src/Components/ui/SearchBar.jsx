...
function SearchBar() {
  return (
    <div className=" flex h-15 w-full bg-none items-center rounded-full p-1">
      <div
        className=" flex h-full w-full lg:w-2/3 items-center p-1 rounded-full bg-white border border-gray-200 border-b-2 border-r-2 border-gray-300
    ...
    focus-within:-translate-y-px"
      >
        <input
          ...
          className="rounded-4xl h-full w-3/4 md:w-4/5 p-4 border-none outline-none"
        ></input>
